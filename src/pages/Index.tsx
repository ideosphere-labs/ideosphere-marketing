...
import { ArrowRight, Network, Microscope, Zap, Trophy, ChevronDown, Atom, Brain, FlaskConical, Binary } from "lucide-react";
...
// Enhanced FAQ Component with sci-fi animations
  ...
  <Collapsible className="group">
    <CollapsibleTrigger className="w-full">
      <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-slate-800/50 to-slate-900/50 border border-slate-800/50 p-6 hover:border-cyan-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-cyan-500/10">
        ...
        <div className="absolute inset-0">
          ...
          {/* Animated grid lines */}
          <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(6,182,212,0.1)_1px,transparent_1px),linear-gradient(to_bottom,rgba(6,182,212,0.1)_1px,transparent_1px)] bg-[size:14px_14px] opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
        </div>
        <div className="relative z-10 flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <div className="rounded-full p-2 bg-cyan-500/10 text-cyan-400 group-hover:scale-110 transition-transform duration-300">
    ...
    <CollapsibleContent>
      <div className="overflow-hidden">
        <div className="relative p-8 text-slate-300 bg-gradient-to-br from-slate-800/50 to-slate-900/50 rounded-b-xl border-x border-b border-slate-800/50">
          {/* Answer background animations */}
          <div className="absolute inset-0">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,rgba(6,182,212,0.1),transparent_50%)]" />
            <div className="absolute inset-0 bg-[linear-gradient(45deg,rgba(6,182,212,0.05)_25%,transparent_25%,transparent_50%,rgba(6,182,212,0.05)_50%,rgba(6,182,212,0.05)_75%,transparent_75%,transparent)] bg-[size:24px_24px]" />
          </div>
          {/* Animated side decoration */}
          <div className="absolute left-0 top-0 h-full w-1 bg-gradient-to-b from-cyan-500/50 to-blue-500/50" />
