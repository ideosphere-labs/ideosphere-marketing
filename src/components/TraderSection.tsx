...
const STYLE_ID = "trader-animations";
...
function TraderSection() {
  ...
  useEffect(() => {
    ...
    style.innerHTML = `
      ...
      .bento3-trader-metrics {
        gap: clamp(1rem, 3vw, 1.5rem);
        padding: clamp(1.25rem, 4vw, 2.5rem);
      }
      .bento3-trader-footer {
        gap: clamp(1.15rem, 3.5vw, 2.4rem);
      }
      .bento3-trader-pill {
        flex-wrap: wrap;
      }
      .bento3-trader-pill span:last-child {
        flex-shrink: 0;
      }
      .bento3-trader-card {
        opacity: 0;
      ...
      .bento3-trader-card[data-visible="true"] {
      ...
      .bento3-trader-icon::before,
      .bento3-trader-icon::after {
        content: "";
        position: absolute;
        inset: 4px;
      ...
      .bento3-trader-icon[data-variant="orbit"] span {
        position: absolute;
        height: 140%;
        width: 3px;
      ...
      .bento3-trader-icon[data-variant="relay"] span {
        position: absolute;
        inset: 18px;
      ...
      .bento3-trader-icon[data-variant="relay"] span::before,
      .bento3-trader-icon[data-variant="relay"] span::after {
        content: "";
        position: absolute;
        height: 1px;
        width: 120%;
      ...
      .bento3-trader-icon[data-variant="wave"] span {
        position: absolute;
        inset: 12px;
        border-radius: 999px;
        overflow: hidden;
      }
      .bento3-trader-icon[data-variant="wave"] span::before {
        content: "";
        position: absolute;
        inset: 0;
      ...
      .bento3-trader-icon[data-variant="spark"] span {
        position: absolute;
        inset: 0;
      }
      .bento3-trader-icon[data-variant="spark"] span::before,
      .bento3-trader-icon[data-variant="spark"] span::after {
        content: "";
        position: absolute;
        inset: 12px;
        border-radius: 9999px;
      ...
      .bento3-trader-icon[data-variant="loop"] span {
        position: absolute;
        inset: 12px;
      }
      .bento3-trader-icon[data-variant="loop"] span::before,
      .bento3-trader-icon[data-variant="loop"] span::after {
        content: "";
        position: absolute;
        height: 1px;
        width: 100%;
  ...
  return (
    <div
      className={`bento3-trader-root relative w-full overflow-hidden transition-colors duration-700 ${palette.surface}`}
    ...
    >
      ...
      <section
        ref={sectionRef}
        className={`bento3-trader-section relative z-10 mx-auto flex max-w-6xl flex-col gap-12 py-24 md:gap-16 ${
      ...
      >
        ...
        <div className="bento3-trader-grid grid grid-cols-1 gap-5 md:grid-cols-2 md:gap-6 xl:gap-8">
          {traderFlows.map((flow, index) => (
            <FlowCard
              key={flow.id}
              flow={flow}
              palette={palette}
        ...
        <div
          className={`bento3-trader-metrics grid grid-cols-1 gap-4 rounded-[28px] border p-6 sm:grid-cols-2 md:grid-cols-3 ${palette.cardBorder} ${palette.card}`}
        >
          {traderMetrics.map((metric) => (
            <div
              key={metric.label}
...
function FlowCard({ flow, palette, index, visible }) {
  ...
  return (
    <article
      ref={cardRef}
      className={`bento3-trader-card group relative overflow-hidden rounded-[28px] border ${palette.cardBorder} ${palette.card} p-6 transition-all duration-500 hover:border-cyan-500/50 hover:shadow-lg hover:shadow-cyan-500/10`}
...
function AnimatedIcon({ variant }) {
  return (
    <span className="bento3-trader-icon" data-variant={variant}>
      <span />
    </span>
  );
}
