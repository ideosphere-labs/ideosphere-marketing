      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6 flex flex-col lg:flex-row items-center justify-between gap-16 pt-24">
        ...
        <div className="max-w-2xl text-left">
          ...
          <motion.div
            ...
            animate="visible"
          >
            <h1 className="text-4xl sm:text-6xl md:text-7xl font-normal mb-6 md:mb-8 tracking-tight">
              ...
              <span
                className={cn(
                  "bg-clip-text text-transparent bg-gradient-to-r from-cyan-300 via-white/90 to-blue-300"
                )}
              >
                {title2}
              </span>
