          ...
          {[...Array(10)].map((_, i) => (
            <g key={`helix-${i}`} className="animate-float" style={{ animationDelay: `${i * 0.2}s` }}>
              <path
                ...
                className="text-cyan-500 animate-network"
                stroke="currentColor"
                strokeWidth="0.2"
                fill="none"
              />
...
const FeatureCard = ({ icon: Icon, title, description }) => (
  <div className="group relative overflow-hidden rounded-xl frosted-glass p-8 transition-all duration-500 hover:scale-[1.02]">
    ...
    <div className="relative z-10">
      <div className="rounded-full w-12 h-12 bg-gradient-to-br from-cyan-500 to-blue-600 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
...
const FAQ = ({ question, answer }) => (
  <Collapsible className="group">
    <CollapsibleTrigger className="w-full">
      <div className="relative overflow-hidden rounded-xl frosted-glass p-6 transition-all duration-300 hover:shadow-lg hover:shadow-cyan-500/10">
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(6,182,212,0.1),transparent_50%)] opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
        </div>
    ...
    <CollapsibleContent>
      <div className="overflow-hidden">
        <div className="p-6 text-slate-300 frosted-glass rounded-b-xl">
          <div className="relative z-10">
            {answer}
          </div>
        </div>
...
const Index = () => {
  return (
    <div className="min-h-screen text-slate-100">
      {/* Navigation */}
      <nav className="fixed top-0 w-full z-50 frosted-glass">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <Button className="bg-gradient-to-r from-cyan-500 to-blue-600 text-white border-0 hover:scale-105 transition-transform duration-300">
              Join the waitlist
            </Button>
          </div>
        </div>
      ...
      <section className="relative pt-32 flex items-center justify-center min-h-screen">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center text-center">
            <div className="inline-flex px-4 py-2 rounded-full frosted-glass text-cyan-400 border border-cyan-500/20 text-sm font-medium mb-12 animate-pulse-glow">
              Access Now Open
            </div>
            
            <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-[1.1] animate-float">
      ...
      <section className="relative py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold mb-12 text-center">For Researchers</h2>
      ...
      <section className="relative py-24">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            ...
            />
            <FAQ 
              question="How do researchers receive funding?" 
...
This creates a transparent system where the scientific community's expertise, combined with economic incentives, ensures reliable verification of research outcomes.`}
            />
            <FAQ 
              question="How do researchers submit projects?" 
